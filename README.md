...
Second, run the program “Main_DMSGVBM_CV.py” to get all the prediction results of BLTDMDGL for the two benchmark datasets in the scenarios of CV_triplet, CV_drug, CV_micro and CV_dis.
